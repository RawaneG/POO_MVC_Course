        ...
        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
          <form style="width: 23rem;" action="/login" method="POST">
            ...
            <div class="form-outline mb-4">
              ...
              <input type="email" id="form2Example18" class="form-control form-control-lg" name="login"/>
            </div>
            ...
            <p>Vous n'avez pas de compte ? <a href="/register" class="link-info">Inscrivez-vous</a></p>
